...
export default function handler(
  ...
  try {
    ...
    if (lowercaseQuery.match(/(hello|hi|hey|greetings|good\s+(morning|afternoon|evening|day)|howdy|yo|sup)/i)) {
      ...
      response = `${greeting}! I'm the RevX AI assistant. How can I help you today? Feel free to ask about our services, success stories, or how to get in touch with us.`;
    }
      ...
      response = "I'm not sure I understand your question. You can ask me about RevX's services, contact information, or specific topics like digital marketing, e-commerce, development, or revenue optimization. How else can I assist you?";
    }
